...
/* parada_pagination by Patrick */

function parada_pagination($start_end_links = 5, $middle_links = 5)
{
	global $wp_query;		
	// No parada_pagination on pages
	if(!is_single())	
	{			
		...
		// parada_pagination issue only if more than one index page is
		if($total > 1)	
		{				
			// parada_pagination initial
